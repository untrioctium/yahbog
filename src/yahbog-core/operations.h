...
#define OPCODE_ARGS yahbog::registers& reg, [[maybe_unused]] yahbog::addressable* mem
...
namespace opcodes {
    ...
    static void adc_aa(OPCODE_ARGS) noexcept {
        auto fc = reg.FC();
    ...
    static void adc_n8(OPCODE_ARGS) noexcept {
    ...
    static void add_aa(OPCODE_ARGS) noexcept {
    ...
    static void add_n8(OPCODE_ARGS) noexcept {
    ...
    static void and_aa(OPCODE_ARGS) noexcept {
        reg.FZ(reg.a == 0);
    ...
    static void and_n8(OPCODE_ARGS) noexcept {
    ...
    static void call_n16(OPCODE_ARGS) noexcept {
    ...
    static void ccf(OPCODE_ARGS) noexcept {
        reg.FC(!reg.FC());
        reg.FN(0); reg.FH(0);
    ...
    static void cp_aa(OPCODE_ARGS) noexcept {
    ...
    static void cp_n8(OPCODE_ARGS) noexcept {
    ...
    static void cpl(OPCODE_ARGS) noexcept {
        reg.a = ~reg.a;
        reg.FN(1); reg.FH(1);
    ...
    static void daa(OPCODE_ARGS) noexcept {
        auto adjust = 0;
    ...
    static void di(OPCODE_ARGS) noexcept {
        reg.ime = 0;
    ...
    static void ei(OPCODE_ARGS) noexcept {
        reg.ie = 1;
    ...
    static void halt(OPCODE_ARGS) noexcept {
    }

    static void illegal(OPCODE_ARGS) noexcept {
        // no-op
    ...
    static void jp_n16(OPCODE_ARGS) noexcept {
    ...
    static void jr_n8(OPCODE_ARGS) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(reg.pc);
            reg.pc++;
    ...
    static void nop(OPCODE_ARGS) noexcept {
        reg.ir = mem->read(reg.pc);
        reg.pc++;
    }

    static void or_aa(OPCODE_ARGS) noexcept {
        reg.FZ(reg.a == 0);
    ...
    static void or_n8(OPCODE_ARGS) noexcept {
    ...
    static void prefix(OPCODE_ARGS) noexcept {
        reg.ir = mem->read(reg.pc) + 0x100;
        reg.pc++;
    }

    static void ret(OPCODE_ARGS) noexcept {
    ...
    static void reti(OPCODE_ARGS) noexcept {
    ...
    static void rla(OPCODE_ARGS) noexcept {
        auto carry = reg.FC();
        reg.FC(reg.a >> 7);
        reg.a = (reg.a << 1) | carry;
    ...
    static void rlca(OPCODE_ARGS) noexcept {
        reg.FC(reg.a >> 7);
    ...
    static void rra(OPCODE_ARGS) noexcept {
        auto carry = reg.FC();
        reg.FC(reg.a & 1);
    ...
    static void rrca(OPCODE_ARGS) noexcept {
        reg.FC(reg.a & 1);
    ...
    static void sbc_aa(OPCODE_ARGS) noexcept {
    ...
    static void sbc_n8(OPCODE_ARGS) noexcept {
    ...
    static void scf(OPCODE_ARGS) noexcept {
    ...
    static void stop_n8(OPCODE_ARGS) noexcept {
        reg.pc++;
    }

    static void sub_aa(OPCODE_ARGS) noexcept {
        reg.a = 0;
        reg.FZ(1); reg.FN(1); reg.FH(0); reg.FC(0);
    ...
    static void sub_n8(OPCODE_ARGS) noexcept {
    ...
    static void xor_aa(OPCODE_ARGS) noexcept {
        reg.a = 0;
    ...
    static void xor_n8(OPCODE_ARGS) noexcept {
    ...
    void bit_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<int op1, regpair_t op2>
    void res_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<int op1, regpair_t op2>
    void set_r16P(registers& reg, addressable* mem) noexcept {
    ...
    void bit_r8(registers& reg, addressable* mem) noexcept {
        auto val = reg.*op2;
        auto bit = 1 << op1;
    ...
    template<int op1, r8_ptr op2>
    void res_r8(registers& reg, addressable* mem) noexcept {
        auto val = reg.*op2;
        auto bit = 1 << op1;
    ...
    template<int op1, r8_ptr op2>
    void set_r8(registers& reg, addressable* mem) noexcept {
        auto val = reg.*op2;
        auto bit = 1 << op1;
    ...
    template<int op1>
    void rst_n8(registers& reg, addressable* mem) noexcept {
    ...
    void call_cc_n16(registers& reg, addressable* mem) noexcept {
    ...
    template<jump_condition op1>
    void jp_cc_n16(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(reg.pc);
            reg.pc++;
    ...
    template<jump_condition op1>
    void jr_cc_n8(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(reg.pc);
            reg.pc++;
    ...
    template<jump_condition op1>
    void ret_cc(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            if (!jump_condition_met<op1>(reg, mem)) {
                reg.mupc = 4;
    ...
    void add_r16_r16(registers& reg, addressable* mem) noexcept {
    ...
    void add_hl_sp(registers& reg, addressable* mem) noexcept {
    ...
    void ld_sp_hl(registers& reg, addressable* mem) noexcept {
    ...
    void ld_hl_sp_n8(registers& reg, addressable* mem) noexcept {
    ...
    void ld_r16PD_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1, r8_ptr op2>
    void ld_r16PI_r8(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            mem->write(op1(reg), reg.*op2);
            op1(reg, op1(reg) + 1);
    ...
    template<regpair_t op1, r8_ptr op2>
    void ld_r16P_r8(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            mem->write(op1(reg), reg.*op2);
            reg.mupc = 1;
    ...
    void adc_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void add_r16P(registers& reg, addressable* mem) noexcept {
    ...
    void add_sp_n8(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void and_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void cp_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void dec_r16(registers& reg, addressable* mem) noexcept {
    ...
    void dec_sp(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void dec_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void inc_r16(registers& reg, addressable* mem) noexcept {
    ...
    void inc_sp(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void inc_r16P(registers& reg, addressable* mem) noexcept {
    ...
    void jp_hl(registers& reg, addressable* mem) noexcept {
        reg.ir = mem->read(reg.hl());
        reg.pc = reg.hl() + 1;
    }

    template<r16_ptr op1>
    void ld_n16P_r16(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void ld_r16P_n8(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void ld_r16_n16(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(reg.pc);
            reg.pc++;
    ...
    void ld_sp_n16(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(reg.pc);
            reg.pc++;
    ...
    template<regpair_t op1>
    void or_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void pop_r16(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void push_r16(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void rl_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void rlc_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void rr_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void rrc_r16P(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(op1(reg));
            reg.mupc = 1;
    ...
    template<regpair_t op1>
    void sbc_r16P(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(op1(reg));
            reg.mupc = 1;
    ...
    template<regpair_t op1>
    void sla_r16P(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(op1(reg));
            reg.mupc = 1;
    ...
    template<regpair_t op1>
    void sra_r16P(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(op1(reg));
            reg.mupc = 1;
    ...
    template<regpair_t op1>
    void srl_r16P(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(op1(reg));
            reg.mupc = 1;
    ...
    template<regpair_t op1>
    void sub_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<regpair_t op1>
    void swap_r16P(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(op1(reg));
            reg.mupc = 1;
    ...
    template<regpair_t op1>
    void xor_r16P(registers& reg, addressable* mem) noexcept {
    ...
    void ld_r8_r16P(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1, regpair_t op2>
    void ld_r8_r16PD(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
            reg.z = mem->read(op2(reg));
            reg.mupc = 1;
    ...
    void ld_a_hlp(registers& reg, addressable* mem) noexcept {
        switch (reg.mupc) {
        case 0:
    ...
    void ld_r8_r8(registers& reg, addressable* mem) noexcept {
        reg.*op1 = reg.*op2;
    ...
    template<r8_ptr op1, r8_ptr op2>
    void ldh_r8P_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1, r8_ptr op2>
    void ldh_r8_r8P(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void adc_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void add_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void and_r8(registers& reg, addressable* mem) noexcept {
        reg.a &= reg.*op1;
    ...
    template<r8_ptr op1>
    void cp_r8(registers& reg, addressable* mem) noexcept {
        auto op = reg.*op1;
    ...
    template<r8_ptr op1>
    void dec_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void inc_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void jr_r8_n8(registers& reg, addressable* mem) noexcept {
        reg.mupc = 255;
        return;
    ...
    template<r8_ptr op1>
    void ld_n16P_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void ld_r8_n16P(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void ld_r8_n8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void ldh_n8P_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void ldh_r8_n8P(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void or_r8(registers& reg, addressable* mem) noexcept {
        reg.a |= reg.*op1;
    ...
    template<r8_ptr op1>
    void rl_r8(registers& reg, addressable* mem) noexcept {
        auto val = reg.*op1;
        auto carry = reg.FC();
    ...
    template<r8_ptr op1>
    void rlc_r8(registers& reg, addressable* mem) noexcept {
        reg.FC(reg.*op1 >> 7);
    ...
    template<r8_ptr op1>
    void rr_r8(registers& reg, addressable* mem) noexcept {
        auto carry = reg.FC();
    ...
    template<r8_ptr op1>
    void rrc_r8(registers& reg, addressable* mem) noexcept {
        reg.FC(reg.*op1 & 1);
    ...
    template<r8_ptr op1>
    void sbc_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void sla_r8(registers& reg, addressable* mem) noexcept {
        reg.FC(reg.*op1 >> 7);
        reg.*op1 <<= 1;
        reg.FZ(reg.*op1 == 0);
    ...
    template<r8_ptr op1>
    void sra_r8(registers& reg, addressable* mem) noexcept {
        reg.FC(reg.*op1 & 1);
    ...
    template<r8_ptr op1>
    void srl_r8(registers& reg, addressable* mem) noexcept {
        reg.FC(reg.*op1 & 1);
        reg.*op1 >>= 1;
    ...
    template<r8_ptr op1>
    void sub_r8(registers& reg, addressable* mem) noexcept {
        auto op = reg.*op1;
    ...
    template<r8_ptr op1>
    void swap_r8(registers& reg, addressable* mem) noexcept {
    ...
    template<r8_ptr op1>
    void xor_r8(registers& reg, addressable* mem) noexcept {
        reg.a ^= reg.*op1;
